...
setlocal
echo ============================================================
echo AE-039C2 Unit Instance Regression Correction
echo ============================================================
...
".venv\Scripts\python.exe" tools\apply_ae039c2_unit_instance_regression.py
...
echo.
echo AE-039C2 targeted tests passed.
endlocal
