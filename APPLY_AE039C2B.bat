...
setlocal
echo ============================================================
echo AE-039C2B Canonical Unit Instance Test
echo ============================================================
...
".venv\Scripts\python.exe" tools\apply_ae039c2b_canonical_unit_instance_test.py
...
echo.
echo AE-039C2B targeted tests passed.
endlocal
