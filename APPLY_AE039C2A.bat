...
setlocal
echo ============================================================
echo AE-039C2A Robust Unit Instance Regression Correction
echo ============================================================
...
".venv\Scripts\python.exe" tools\apply_ae039c2a_unit_instance_regression.py
...
echo.
echo AE-039C2A targeted tests passed.
endlocal
