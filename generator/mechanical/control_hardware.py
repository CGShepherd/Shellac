"""G3-025 controlled mechanical evidence for selected control hardware."""
...
GRAYHILL_1_DECK = MechanicalEvidence(
    "MECH-SW901-902", "Grayhill", "71BDF30-01-2-AJN",
    "Bass/Treble rotary", "panel + through-hole PC mount, right-angle",
    ...
    notes="Adjustable 2-6 positions; two poles/deck; BBM/non-shorting.",
)

GRAYHILL_2_DECK = MechanicalEvidence(
    "MECH-SW903", "Grayhill", "71BDF30-02-2-AJN",
    "Channel Mode rotary", "panel + through-hole PC mount, right-angle",
    behind_panel_depth_mm=24.87, shaft_diameter_mm=6.35,
    shaft_projection_mm=9.53, bushing_thread="3/8-32 UNEF",
    bushing_length_mm=7.92,
    evidence_grade="E1 exact product + E3 dimensional cross-check",
    notes="Adjustable 2-6 positions; two decks, two poles/deck; BBM/non-shorting.",
)
...
def validate_control_mechanical_evidence() -> None:
    ...
    assert all(not item.manufacturing_released for item in EXTERNAL_CONTROL_CONTRACTS)
