...
def build_interface_architecture() -> InterfaceArchitecture:
    family = EnclosureFamilyFreeze(
        ...
        family_status="FROZEN — enclosure family and finish selected; exact sizes remain drawing-gated",
        exact_audio_order_code=None,
    ...
    return InterfaceArchitecture(
        ...
        revision="Rev A0",
        status="ARCHITECTURE_FROZEN — exact enclosure sizes and drilling coordinates remain open",
        ...
        open_items=[
            "freeze exact black UNICASE order code for audio chassis from manufacturer drawing and PCB/control fit",
            "freeze exact black UNICASE order code for PSU chassis from component layout, segregation and thermal fit",
