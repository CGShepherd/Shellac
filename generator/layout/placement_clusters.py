...
def build_cluster_placement_baseline(
    ...
    clusters = [
        ...
        _cluster("CLU-104", "Isolation buffers", "SCH104", "REG-05",
                 "U401 R4001 R4501 TP4001 TP4002 TP4501 TP4502 C4091 C4092 C4093 C4094", "U401",
        ...
        _cluster("CLU-105", "Passive mode matrix and buffers", "SCH105", "REG-05",
                 "R501 R502 U501 R510 R511 R520 R521 TP501 TP502 TP503 TP504 TP505 C5091 C5092 C5093 C5094", "U501", interfaces="SW501",
