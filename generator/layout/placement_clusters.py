...
def build_cluster_placement_baseline(
    ...
    clusters = [
        _cluster("CLU-101-A", "Left input RF and connector interface", "SCH101", "REG-01",
                 "H101 R102 R103 R104 R105 C101 C102 C103 C104", "H101",
        ...
        _cluster("CLU-101-B", "Left gain and differential conversion", "SCH101", "REG-01",
                 "U101 R111 R112 R113 R114 R121 R122 R123 R124 U103 RN130 C191 C192 C193 C194", "U101 U103",
                 after=("CLU-101-A",), span=32.0, orientation="Plus/minus gain legs remain visually paired; converter follows them toward EQ.",
                 adjacency="Gain/converter feedback parts within 6 mm; C191-C194 local rail bypasses remain physically local to their owning U101/U103 supply pins.",
        ...
        _cluster("CLU-101-C", "Right input RF and connector interface", "SCH101", "REG-01",
                 "H201 R202 R203 R204 R205 C201 C202 C203 C204", "H201",
                 edge=EdgeAffinity.FRONT, span=18.0, orientation="Connector-facing RF chain flows inward from front board edge.",
        ...
        _cluster("CLU-101-D", "Right gain and differential conversion", "SCH101", "REG-01",
                 "U201 R211 R212 R213 R214 R221 R222 R223 R224 U203 RN230 C291 C292 C293 C294", "U201 U203",
                 after=("CLU-101-C",), span=32.0, orientation="Plus/minus gain legs remain visually paired; converter follows them toward EQ.",
                 adjacency="Gain/converter feedback parts within 6 mm; C291-C294 local rail bypasses remain physically local to their owning U201/U203 supply pins.",
                 keepout="No harness or unrelated trace between paired gain legs.",
                 routing="Manual feedback and differential-converter routes; zero vias."),
        _cluster("CLU-101-E", "SCH101 four-gang gain service programming", "SCH101", "REG-01",
                 "H110 H111 H112", "H110 H111 H112",
                 after=("CLU-101-B","CLU-101-D"), span=28.0,
                 orientation="LOW/HIGH/PARK headers form one central service bank; pad-pair orientation remains verification-gated.",
                 adjacency="Programming resistors remain at their owning amplifier nodes; header fan-out is manual analogue-critical routing.",
                 keepout="No unrelated routing through gain-program header fan-out.",
                 routing="Manual only; final routes blocked until production MNT-104 pairing/orientation is verified."),
        _cluster("CLU-101-F", "SCH101 ganged cartridge-load service programming", "SCH101", "REG-01",
                 "H120 H121 H122", "H120 H121 H122",
                 edge=EdgeAffinity.FRONT, after=("CLU-101-A","CLU-101-C"), span=24.0,
                 orientation="+47/BASE/+100 headers remain near and symmetrical to both cartridge-input loading regions.",
                 adjacency="C103/C104 and C203/C204 remain local to their cartridge nodes; header runs are short, symmetrical and isolated.",
                 keepout="No digital/control/output routing through the low-level load-programming fan-out.",
                 routing="Manual only; final routes blocked pending shunt-pairing and parasitic/layout acceptance."),
        ...
        _cluster("CLU-103-HF-L", "Left passive treble and recovery", "SCH103", "REG-02",
                 "R30030 C30020 C30021 C30022 C30023 C30024 C30025 C30026 R30040 R30041 TP3003 TP3004 TP3005 C30050 C30051 C30052 C30053 C30060 R30060", "U3001", interfaces="SW3002",
        ...
        _cluster("CLU-103-HF-R", "Right passive treble and recovery", "SCH103", "REG-03",
                 "R35030 C35020 C35021 C35022 C35023 C35024 C35025 C35026 R35040 R35041 TP3503 TP3504 TP3505 C35050 C35051 C35052 C35053 C35060 R35060", "U3501", interfaces="SW3502",
        ...
        _cluster("CLU-107-L", "Left two-section rumble filter", "SCH107", "REG-04",
                 "U700 C7001 C7002 R7001 R7002 C7201 C7202 R7201 R7202 R70090 C70091 C70092 C70093 C70094 TP7001 TP7002 TP7003 TP7004", "U700", interfaces="SW1071",
        ...
        _cluster("CLU-107-R", "Right two-section rumble filter", "SCH107", "REG-04",
                 "U750 C7501 C7502 R7501 R7502 C7701 C7702 R7701 R7702 R75090 C75091 C75092 C75093 C75094 TP7501 TP7502 TP7503 TP7504", "U750",
        ...
        _cluster("CLU-104", "Isolation buffers", "SCH104", "REG-05",
                 "U401 R4001 R4002 R4501 R4502 TP4001 TP4002 TP4501 TP4502 C4091 C4092 C4093 C4094", "U401",
        ...
        _cluster("CLU-105", "Passive mode matrix and buffers", "SCH105", "REG-05",
                 "U501 R510 R511 R520 R521 TP501 TP502 TP503 TP504 TP505 TP506 C5091 C5092 C5093 C5094", "U501", interfaces="SW501",
        ...
        _cluster("CLU-109", "Top-panel PCB control and indicator interface", "SCH109", "REG-08",
                 "R906 R907 TP9901 TP9902", "TP9901 TP9902", interfaces="SW901L SW901R SW902L SW902R SW903 SW904 SW905 LED901 LED902",
