...
FINDINGS = (
    Finding("AE036-F01","P0","build-system","clean build can delete native PCB","CLOSED",False,
            "AE-036A/B preserve native PCB/design-rule artifacts during generator cleanup; validated by clean build and regression."),
    Finding("AE036-F02","P0","SCH101","cartridge loading/common-mode bias/RF response not closed","CLOSED",False,
            "AE-037/037A/037B/037C3 define 47.4k differential loading, explicit DC bias return and fixed 47p common-mode RF shunts; AE-071A supersedes the old 22p DNP with controlled service-capacitance programming."),
    Finding("AE036-F03","P0/P1","physical-CAD","dual op-amp package/unit semantics not closed","CLOSED",False,
    ...
    Finding("AE071-F01","P0","product-migration","AE-042 SCH101 selected-next implementation not yet migrated into live product generator","CLOSED",False,
            "AE-071A migrates the AE-042 fail-safe 999R/1k gain network, 332R LOW and 866R HIGH programming branches, BASE/+47/+100p service loading, physical service headers, placement ownership, BOM and current authority."),
    ...
    Finding("AE071-F08","P1","SCH101-service-hardware","Samtec shunt pairing/orientation and cartridge-load service-header parasitic/layout correlation remain open","OPEN",True),
)
