...
def build_shellac_model() -> ProjectModel:
    ...
    signal_specs = [
        ...
        ("BASS_L_SELECT", SignalKind.CONTROL, "Left replay bass-characteristic switch state."),
        ("BASS_R_SELECT", SignalKind.CONTROL, "Right replay bass-characteristic switch state."),
        ("TREBLE_L_SELECT", SignalKind.CONTROL, "Left replay treble-characteristic switch state."),
        ("TREBLE_R_SELECT", SignalKind.CONTROL, "Right replay treble-characteristic switch state."),
        ("MODE_SELECT", SignalKind.CONTROL, "Stereo/mono routing selection."),
        ("MONO_AVG", SignalKind.ANALOG, "Left permanent averaging leg and switched L+R arithmetic-average node."),
        ("MONO_R_LEG", SignalKind.ANALOG, "Right averaging leg presented to SW903 Pole C."),
    ...
    eq_block = FunctionalBlock(
        ...
        interfaces=[
            ...
            _interface("BASS_L", "BASS_L_SELECT", Direction.INPUT),
            _interface("BASS_R", "BASS_R_SELECT", Direction.INPUT),
            _interface("TREBLE_L", "TREBLE_L_SELECT", Direction.INPUT),
            _interface("TREBLE_R", "TREBLE_R_SELECT", Direction.INPUT),
            _interface("+V", "+18V", Direction.POWER),
            _interface("-V", "-18V", Direction.POWER),
            _interface("0VA", "0VA", Direction.GROUND),
        ],
    ...
    buffer_block = FunctionalBlock(
        ...
        interfaces=[
            ...
            _interface("MONO_AVG", "MONO_AVG", Direction.OUTPUT),
            _interface("MONO_R_LEG", "MONO_R_LEG", Direction.OUTPUT),
            _interface("+V", "+18V", Direction.POWER),
            _interface("-V", "-18V", Direction.POWER),
            _interface("0VA", "0VA", Direction.GROUND),
        ],
    ...
    mode_block = FunctionalBlock(
        ...
        interfaces=[
            ...
            _interface("MONO_AVG", "MONO_AVG", Direction.INPUT),
            _interface("MONO_R_LEG", "MONO_R_LEG", Direction.INPUT),
    ...
    controls = FunctionalBlock(
        ...
        interfaces=[
            _interface("BASS_L", "BASS_L_SELECT", Direction.OUTPUT),
            _interface("BASS_R", "BASS_R_SELECT", Direction.OUTPUT),
            _interface("TREBLE_L", "TREBLE_L_SELECT", Direction.OUTPUT),
            _interface("TREBLE_R", "TREBLE_R_SELECT", Direction.OUTPUT),
