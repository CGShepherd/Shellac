"""G3-024 / AE-009 SCH109 controls and user-interface engineering model."""
...
ROTARY_MANUFACTURER = "Grayhill"
ROTARY_BASS_TREBLE_MPN = "71BDF30-01-2-AJN"
ROTARY_MODE_MPN = "71BDF30-02-2-AJN"
...
CONTROLS = (
    ControlDefinition("SW901", "Bass characteristic", "2P6 rotary configured to 5 positions",
    ...
    ControlDefinition("SW902", "Treble characteristic", "2P6 rotary configured to 5 positions",
    ...
    ControlDefinition("SW903", "Channel mode", "4P6 rotary configured to 4 positions",
