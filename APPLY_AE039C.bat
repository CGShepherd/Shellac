...
setlocal
echo ============================================================
echo AE-039C Real KiCad Op-Amp Unit / Pin Semantics
echo ============================================================
if not exist ".venv\Scripts\python.exe" (
  echo ERROR: Run from Shellac repository root.
  exit /b 1
)
".venv\Scripts\python.exe" tools\apply_ae039c_real_kicad_opamp_units.py
...
if errorlevel 1 exit /b 1
echo.
echo AE-039C targeted tests passed.
endlocal
